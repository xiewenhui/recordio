...
#ifndef COMMONLIB_STRINGPIECE_H_
#define COMMONLIB_STRINGPIECE_H_
...
bool operator==(const commonlib::util::StringPiece& x,
                const commonlib::util::StringPiece& y);

inline bool operator!=(const commonlib::util::StringPiece& x,
                       const commonlib::util::StringPiece& y) {
  return !(x == y);
}
...
extern std::ostream& operator<<(std::ostream& o,
                                const commonlib::util::StringPiece& piece);

#endif  // COMMONLIB_STRINGPIECE_H_
